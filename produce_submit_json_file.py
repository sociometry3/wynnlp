...
class Sorted_relation_and_entity_list_Management(File_Management):
    ...
    def __init__(self, TEST_DATA_DIR, MODEL_OUTPUT_DIR, Competition_Mode=False):
        ...
        self.relationship_label_list = ['集计','分类','维度','模糊分类','模糊维度','保留','排除','升序','降序','时间范围']
        self.Competition_Mode = Competition_Mode
    ...
    def get_input_list(self,):
        ...
        if len(content_list_summary) == 4:
            ...
            print('------------------------', text_sentence_list, token_in_not_NUK_list, token_label_list)
...
if __name__=='__main__':
    TEST_DATA_DIR = "bin/sequence_labeling_data/test"
